# -*- encoding: utf-8 -*-
# stub: actionpack 7.2.0.beta2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v7.2.0.beta2/actionpack/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v7.2.0.beta2/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v7.2.0.beta2/actionpack" } if s.respond_to? :metadata=
